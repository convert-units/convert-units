var convert
  ...
  , measures = {
    ...
    , bits: require('./definitions/bits')
    , bitspersecond: require('./definitions/bitspersecond')
    , bytes: require('./definitions/bytes')
    , bytespersecond: require('./definitions/bytespersecond')
    , bibytes: require('./definitions/bibytes')
    , bibytespersecond: require('./definitions/bibytespersecond')
    , bibits: require('./definitions/bibits')
    , bibitspersecond: require('./definitions/bibitspersecond')
