var convert
  ...
  , measures = {
    ...
    , massConcentration: require('./definitions/massConcentration')
    }
  , Converter;
...
Converter.prototype.to = function (to) {
  ...
  */
  ...
  /**
   * Convert to another unit inside the destination system (round-off errors)
   */
  if (this.destination.unit.to_anchor.toString().indexOf('e-') !== -1) {
    return result * Number.parseFloat(this.destination.unit.to_anchor.toString().replace('e-', 'e'))
  }
