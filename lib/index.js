var convert
  ...
  , measures = {
    ...
    , cropRate: require('./definitions/cropRate')
		, volumeCropRate: require('./definitions/volumeCropRate')
		, bushelCropRate: require('./definitions/bushelCropRate')
		, metricTonneCropRate: require('./definitions/metricTonneCropRate')
		, seedRate: require('./definitions/seedRate')
    }
  , Converter;
